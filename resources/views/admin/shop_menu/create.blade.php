<x-admin-layout>
    ...
    <div
        ...
        <div class="flex justify-between">
            <h5 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">「{{ $shop->name }}」で食べたうどんを登録</h5>
            <a href="{{ route('admin.shop_menu.index', $shop) }}"
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="mt-5 md:mt-0 md:col-span-3">
            <form action="{{ route('admin.shop_menu.store',$shop) }}" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
                    ...
                    <div class="px-2 sm:px-4 py-5 sm:p-10">
                        <div class="grid grid-cols-6 gap-5">
                            ...
                            <div class="col-span-6 sm:col-span-4 border-t border-gray-100 pt-2">
                                ...
                                @include('components.form.create.file', ['name' => 'image_path'])
                            </div>
                            <div class="col-span-6 sm:col-span-2">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-4 border-t border-gray-100 pt-2">
                                ...
                                @include('components.form.create.input', ['name' => 'price'])
                            </div>
                            <div class="col-span-6 sm:col-span-2">
                            </div>
